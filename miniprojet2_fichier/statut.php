...
echo "<td><a classe='button' href='geststatut.php?id=$col[0]'> <button";
if($col[7]=='Présent(e)')
{
    echo" style='background-color:green'>$col[7]</button></a></td>";   
}
else
{
    echo" style='background-color:red' >$col[7]</button></a></td>";   
}
 echo '</tr>';
