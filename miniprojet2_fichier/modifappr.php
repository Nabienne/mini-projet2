...
<center>
<form class="needs-validation" novalidate method="POST" action="modifappr.php">
<table>
<div class="form-row">
<div class="col-md-4 mb-3">
    ...
    <div class="col-md-4 mb-3">
    <td><em>INE</em> </td>
	<td><input type="texte" name="id"  placeholder="identifiant" requiredtd>
		</tr>
    <div class="valid-tooltip">
        Looks good!
      </div>
...
<td><input type="text" name="prenom" placeholder="prenom" required></td>
  ...
  <div class="col-md-4 mb-3">
		...
		<td><select id="text"  name="promo" required>
...
{
$users=fopen('listapprenants.txt','r');
$mail=$_POST['mail'];
$nom=$_POST['nom'];
$prenom=$_POST['prenom'];
$id=$_POST['id'];
...
if($id==$col[0] )
{
    ...
    $col[6]=$statut;
    $col[7]=$promo;
    $modif=$id.";".$nom.";".$prenom.";".$date.";".$tel.";".$mail.";".$statut.";".$promo.";";
}
else
 {
    $modif=$ligne;  
...
fclose($users);
$modifier=fopen('listapprenants.txt','w+' );
